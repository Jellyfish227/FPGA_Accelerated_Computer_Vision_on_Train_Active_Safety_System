...
set proj_board [get_board_parts "*:zcu102:*" -latest_file_version]
...
make_wrapper -files [get_files ./${proj_name}.srcs/sources_1/bd/$proj_name/${proj_name}.bd] -top
import_files -force -norecurse ./${proj_name}.srcs/sources_1/bd/$proj_name/hdl/${proj_name}_wrapper.v
...
save_bd_design
validate_bd_design
generate_target all [get_files ./${proj_name}.srcs/sources_1/bd/$proj_name/${proj_name}.bd]
file mkdir ./$output_dir
        

set fd [open ./$output_dir/README.hw w] 
...
set_property synth_checkpoint_mode Hierarchical [get_files ./${proj_name}.srcs/sources_1/bd/$proj_name/${proj_name}.bd]
...
file copy -force ./${proj_name}.runs/impl_1/${proj_name}_wrapper.bit ./$output_dir/${proj_name}.bit
...
open_run impl_1        
write_hw_platform -force -include_bit -file ./$output_dir/${proj_name}.xsa
