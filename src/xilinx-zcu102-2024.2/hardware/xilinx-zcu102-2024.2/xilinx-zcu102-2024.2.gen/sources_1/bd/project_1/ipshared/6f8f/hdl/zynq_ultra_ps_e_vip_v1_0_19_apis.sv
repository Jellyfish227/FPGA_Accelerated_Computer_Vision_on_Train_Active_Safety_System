/*****************************************************************************
 * File : zynq_ultra_ps_e_vip_v1_0_19_apis.sv
 *
 * Date : 2015-16
 *
   ...
   begin
      ...
      if(succ == 0) begin
        ...
        if(STOP_ON_ERROR) $stop; 
         ...
         $fclose(succ);
         if (start_addr[31:28] === 4'b1010) begin//G_MP0
            if(DEBUG_INFO)
         ...
         end else if (start_addr[31:28] === 4'b1011) begin//G_MP1
            if(DEBUG_INFO)
         ...
         end else if (start_addr[31:29] === 3'b100) begin//G_MP2
            if(DEBUG_INFO)
 ...
 task automatic write_data;
   ...
   begin
    if(!check_master_address(start_addr)) begin
         ...
         if(STOP_ON_ERROR) $stop;
    end else if(start_addr[31:28] === 4'b1010) begin//G_MP0
       if(DEBUG_INFO)
