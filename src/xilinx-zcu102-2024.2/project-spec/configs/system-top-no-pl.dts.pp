# 0 "/home/jellyfish/Documents/FPGA_Accelerated_Computer_Vision_on_Train_Active_Safety_System/src/xilinx-zcu102-2024.2/components/plnx_workspace/device-tree/system-top-no-pl.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/jellyfish/Documents/FPGA_Accelerated_Computer_Vision_on_Train_Active_Safety_System/src/xilinx-zcu102-2024.2/components/plnx_workspace/device-tree/system-top-no-pl.dts"
/dts-v1/;
...
/ {
        ...
        cpus_a53: cpus-a53@0 {
                ...
                psu_cortexa53_0: cpu@0 {
                        ...
                        cpu-frequency = <0x4f7704c9>;
                        xlnx,cpu-clk-freq-hz = <0x4f7704c9>;
        ...
        cpu_opp_table: opp-table-cpu {
                ...
                opp-1333200073 {
                        opp-hz = <0x0 0x4f7704c9>;
                        clock-latency-ns = <0x7a120>;
                        opp-microvolt = <0xf4240>;
                };

                opp-666600036 {
                        opp-hz = <0x0 0x27bb8264>;
                        clock-latency-ns = <0x7a120>;
                        opp-microvolt = <0xf4240>;
                };

                opp-444400024 {
                        opp-hz = <0x0 0x1a7d0198>;
                        clock-latency-ns = <0x7a120>;
                        opp-microvolt = <0xf4240>;
                };

                opp-333300018 {
                        opp-hz = <0x0 0x13ddc132>;
                        clock-latency-ns = <0x7a120>;
                        opp-microvolt = <0xf4240>;
                };
        };
        ...
        amba: axi {
                ...
                i2c0: i2c@ff020000 {
                        ...
                        pinctrl-0 = <0x98>;
                        pinctrl-1 = <0x99>;
                        scl-gpios = <0x45 0xe 0x6>;
                        sda-gpios = <0x45 0xf 0x6>;
                        phandle = <0x47>;
                ...
                i2c1: i2c@ff030000 {
                        ...
                        pinctrl-0 = <0x9a>;
                        pinctrl-1 = <0x9b>;
                        scl-gpios = <0x45 0x10 0x6>;
                        sda-gpios = <0x45 0x11 0x6>;
                        phandle = <0x48>;
                ...
                zynqmp_dpsub: display@fd4a0000 {
                        ...
                        dmas = <0x35 0x0 0x35 0x1 0x35 0x2 0x35 0x3>;
                        clocks = <&zynqmp_clk 0x1c>,
                         <&zynqmp_clk 0x11>,
                         <&zynqmp_clk 0x10>;
                        ...
                        zynqmp_dp_snd_card0: zynqmp-dp-snd-card {
                                ...
                                xlnx,dp-snd-pcm = <0xa7 0xa8>;
                                xlnx,dp-snd-codec = <0xa9>;
                                phandle = <0xfb>;
                        };
                };
                ...
                psu_r5_tcm_ram_global: psu_r5_tcm_ram@ffe00000 {
                        ...
                        status = "okay";
                        power-domains = <&zynqmp_firmware 0xf>;
                ...
                psu_ocm_ram_0: psu_ocm_ram_0@fffc0000 {
                        ...
                        status = "okay";
                        power-domains = <&zynqmp_firmware 0xb>;
                ...
                psu_r5_1_btcm: psu_r5_1_btcm@20000 {
                        ...
                        status = "okay";
                        power-domains = <&zynqmp_firmware 0x12>;
                ...
                psu_r5_1_atcm: psu_r5_1_atcm@0 {
                        ...
                        status = "okay";
                        power-domains = <&zynqmp_firmware 0x11>;
                ...
                psu_r5_0_btcm_lockstep: psu_r5_0_btcm_lockstep@ffe30000 {
                        ...
                        status = "okay";
                        power-domains = <&zynqmp_firmware 0x10>;
        ...
        ina226-u76 {
                ...
                io-channels = <0xac 0x0 0xac 0x1 0xac 0x2 0xac 0x3>;
        };

        ina226-u77 {
                compatible = "iio-hwmon";
                io-channels = <0xad 0x0 0xad 0x1 0xad 0x2 0xad 0x3>;
        };

        ina226-u78 {
                compatible = "iio-hwmon";
                io-channels = <0xae 0x0 0xae 0x1 0xae 0x2 0xae 0x3>;
        };

        ina226-u87 {
                compatible = "iio-hwmon";
                io-channels = <0xaf 0x0 0xaf 0x1 0xaf 0x2 0xaf 0x3>;
        };

        ina226-u85 {
                compatible = "iio-hwmon";
                io-channels = <0xb0 0x0 0xb0 0x1 0xb0 0x2 0xb0 0x3>;
        };

        ina226-u86 {
                compatible = "iio-hwmon";
                io-channels = <0xb1 0x0 0xb1 0x1 0xb1 0x2 0xb1 0x3>;
        };

        ina226-u93 {
                compatible = "iio-hwmon";
                io-channels = <0xb2 0x0 0xb2 0x1 0xb2 0x2 0xb2 0x3>;
        };

        ina226-u88 {
                compatible = "iio-hwmon";
                io-channels = <0xb3 0x0 0xb3 0x1 0xb3 0x2 0xb3 0x3>;
        };

        ina226-u15 {
                compatible = "iio-hwmon";
                io-channels = <0xb4 0x0 0xb4 0x1 0xb4 0x2 0xb4 0x3>;
        };

        ina226-u92 {
                compatible = "iio-hwmon";
                io-channels = <0xb5 0x0 0xb5 0x1 0xb5 0x2 0xb5 0x3>;
        };

        ina226-u79 {
                compatible = "iio-hwmon";
                io-channels = <0xb6 0x0 0xb6 0x1 0xb6 0x2 0xb6 0x3>;
        };

        ina226-u81 {
                compatible = "iio-hwmon";
                io-channels = <0xb7 0x0 0xb7 0x1 0xb7 0x2 0xb7 0x3>;
        };

        ina226-u80 {
                compatible = "iio-hwmon";
                io-channels = <0xb8 0x0 0xb8 0x1 0xb8 0x2 0xb8 0x3>;
        };

        ina226-u84 {
                compatible = "iio-hwmon";
                io-channels = <0xb9 0x0 0xb9 0x1 0xb9 0x2 0xb9 0x3>;
        };

        ina226-u16 {
                compatible = "iio-hwmon";
                io-channels = <0xba 0x0 0xba 0x1 0xba 0x2 0xba 0x3>;
        };

        ina226-u65 {
                compatible = "iio-hwmon";
                io-channels = <0xbb 0x0 0xbb 0x1 0xbb 0x2 0xbb 0x3>;
        };

        ina226-u74 {
                compatible = "iio-hwmon";
                io-channels = <0xbc 0x0 0xbc 0x1 0xbc 0x2 0xbc 0x3>;
        };

        ina226-u75 {
                compatible = "iio-hwmon";
                io-channels = <0xbd 0x0 0xbd 0x1 0xbd 0x2 0xbd 0x3>;
        };
        ...
        __symbols__ {
                ...
                ipi1 = "/axi/ipi@ff310000";
                psu_ipi_1_0 = "/axi/ipi@ff310000/child@0";
                psu_ipi_1_1 = "/axi/ipi@ff310000/child@1";
                psu_ipi_1_2 = "/axi/ipi@ff310000/child@2";
                psu_ipi_1_3 = "/axi/ipi@ff310000/child@3";
                psu_ipi_1_4 = "/axi/ipi@ff310000/child@4";
                psu_ipi_1_5 = "/axi/ipi@ff310000/child@5";
                psu_ipi_1_6 = "/axi/ipi@ff310000/child@6";
                ipi2 = "/axi/ipi@ff320000";
                psu_ipi_2_0 = "/axi/ipi@ff320000/child@0";
                psu_ipi_2_1 = "/axi/ipi@ff320000/child@1";
                psu_ipi_2_2 = "/axi/ipi@ff320000/child@2";
                psu_ipi_2_3 = "/axi/ipi@ff320000/child@3";
                psu_ipi_2_4 = "/axi/ipi@ff320000/child@4";
                psu_ipi_2_5 = "/axi/ipi@ff320000/child@5";
                psu_ipi_2_6 = "/axi/ipi@ff320000/child@6";
                ipi3 = "/axi/ipi@ff330000";
                psu_ipi_3_0 = "/axi/ipi@ff330000/child@0";
                psu_ipi_3_1 = "/axi/ipi@ff330000/child@1";
                psu_ipi_3_2 = "/axi/ipi@ff330000/child@2";
                psu_ipi_3_3 = "/axi/ipi@ff330000/child@3";
                psu_ipi_3_4 = "/axi/ipi@ff330000/child@4";
                psu_ipi_3_5 = "/axi/ipi@ff330000/child@5";
                psu_ipi_3_6 = "/axi/ipi@ff330000/child@6";
                ipi4 = "/axi/ipi@ff331000";
                psu_ipi_4_0 = "/axi/ipi@ff331000/child@0";
                psu_ipi_4_1 = "/axi/ipi@ff331000/child@1";
                psu_ipi_4_2 = "/axi/ipi@ff331000/child@2";
                psu_ipi_4_3 = "/axi/ipi@ff331000/child@3";
                psu_ipi_4_4 = "/axi/ipi@ff331000/child@4";
                psu_ipi_4_5 = "/axi/ipi@ff331000/child@5";
                psu_ipi_4_6 = "/axi/ipi@ff331000/child@6";
                ipi5 = "/axi/ipi@ff332000";
                psu_ipi_5_0 = "/axi/ipi@ff332000/child@0";
                psu_ipi_5_1 = "/axi/ipi@ff332000/child@1";
                psu_ipi_5_2 = "/axi/ipi@ff332000/child@2";
                psu_ipi_5_3 = "/axi/ipi@ff332000/child@3";
                psu_ipi_5_4 = "/axi/ipi@ff332000/child@4";
                psu_ipi_5_5 = "/axi/ipi@ff332000/child@5";
                psu_ipi_5_6 = "/axi/ipi@ff332000/child@6";
                ipi6 = "/axi/ipi@ff333000";
                psu_ipi_6_0 = "/axi/ipi@ff333000/child@0";
                psu_ipi_6_1 = "/axi/ipi@ff333000/child@1";
                psu_ipi_6_2 = "/axi/ipi@ff333000/child@2";
                psu_ipi_6_3 = "/axi/ipi@ff333000/child@3";
                psu_ipi_6_4 = "/axi/ipi@ff333000/child@4";
                psu_ipi_6_5 = "/axi/ipi@ff333000/child@5";
                psu_ipi_6_6 = "/axi/ipi@ff333000/child@6";
