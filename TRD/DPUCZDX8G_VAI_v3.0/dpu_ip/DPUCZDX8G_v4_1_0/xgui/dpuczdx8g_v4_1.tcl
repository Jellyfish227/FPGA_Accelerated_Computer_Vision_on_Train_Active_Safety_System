...
source [file join [file dirname [file dirname [info script]]] gui/dpuczdx8g_v4_1.gtcl]
...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SAVE_ARGMAX_ENA" -parent ${Arch} -widget comboBox
  #Adding Group
...
proc update_PARAM_VALUE.SAVE_ARGMAX_ENA { PARAM_VALUE.SAVE_ARGMAX_ENA } {
	# Procedure called to update SAVE_ARGMAX_ENA when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SAVE_ARGMAX_ENA { PARAM_VALUE.SAVE_ARGMAX_ENA } {
	# Procedure called to validate SAVE_ARGMAX_ENA
	return true
}
...
proc update_MODELPARAM_VALUE.SAVE_ARGMAX_ENA { MODELPARAM_VALUE.SAVE_ARGMAX_ENA PARAM_VALUE.SAVE_ARGMAX_ENA } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SAVE_ARGMAX_ENA}] ${MODELPARAM_VALUE.SAVE_ARGMAX_ENA}
}
