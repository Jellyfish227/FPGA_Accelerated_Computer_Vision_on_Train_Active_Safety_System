...
--               /tmp/tmp.t0bhEaqsGc/temp/hwflow/hwflow_project_1/project_1.gen/sources_1/bd/project_1/ip/project_1_clk_wiz_0_0/project_1_clk_wiz_0_0_sim_netlist.vhdl
...
entity project_1_clk_wiz_0_0_clk_wiz is
  port (
...
end project_1_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of project_1_clk_wiz_0_0_clk_wiz is
  signal clk_in1_project_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_project_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_project_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_project_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out4_project_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out5_project_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out6_project_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out7_project_1_clk_wiz_0_0 : STD_LOGIC;
  ...
  attribute XILINX_TRANSFORM_PINMAP of clkout7_buf : label is "VCC:CE";
...
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_project_1_clk_wiz_0_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_project_1_clk_wiz_0_0,
      O => clk_out3
    );
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out4_project_1_clk_wiz_0_0,
      O => clk_out4
    );
clkout5_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out5_project_1_clk_wiz_0_0,
      O => clk_out5
    );
clkout6_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out6_project_1_clk_wiz_0_0,
      O => clk_out6
    );
clkout7_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out7_project_1_clk_wiz_0_0,
      O => clk_out7
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT1 => clk_out2_project_1_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_project_1_clk_wiz_0_0,
      CLKOUT2B => NLW_mmcme4_adv_inst_CLKOUT2B_UNCONNECTED,
      CLKOUT3 => clk_out4_project_1_clk_wiz_0_0,
      CLKOUT3B => NLW_mmcme4_adv_inst_CLKOUT3B_UNCONNECTED,
      CLKOUT4 => clk_out5_project_1_clk_wiz_0_0,
      CLKOUT5 => clk_out6_project_1_clk_wiz_0_0,
      CLKOUT6 => clk_out7_project_1_clk_wiz_0_0,
...
begin
inst: entity work.project_1_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
