...
dict set dict_prj dict_sys srcs_dir           [file dirname [file dirname [file dirname [file dirname [dict get $dict_prj dict_sys work_dir]]]]]
dict set dict_prj dict_sys ip_dir             [dict get $dict_prj dict_sys srcs_dir]/dpu_ip
...
dict set dict_prj dict_verreg info_ip         \
  dpu           [dict create                  \
    ...
    PROP        [dict create                  \
                ...
                "ALU_PARALLEL_USER"     [lib_param DPU_ALU_PARALLEL_USER] \
                "ALU_LEAKYRELU"         [lib_param DPU_ALU_LEAKYRELU]     \
                "CONV_WR_PARALLEL"      [lib_param DPU_CONV_WP]           \
                "SFM_ENA"               [lib_param DPU_SFM_NUM]           \
                "SAVE_ARGMAX_ENA"       [lib_param DPU_SAVE_ARGMAX_ENA]   \
